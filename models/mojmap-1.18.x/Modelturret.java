...
public class Modelturret<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group2 = partdefinition.addOrReplaceChild("group2", CubeListBuilder.create().texOffs(40, 0)
				.addBox(-5.0F, -19.0F, -13.0F, 10.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(40, 42)
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group", CubeListBuilder.create().texOffs(10, 34)
				.addBox(-3.0F, -9.0F, -1.0F, 6.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 36)
