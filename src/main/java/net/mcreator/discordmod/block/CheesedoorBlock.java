...
public class CheesedoorBlock extends DoorBlock {
	public CheesedoorBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(DiscordModModBlocks.CHEESEDOOR.get(), renderType -> renderType == RenderType.cutout());
	}
}
