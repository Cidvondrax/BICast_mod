...
public class ModelIronGolemModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("discord_mod", "model_iron_golem_model"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition field_78174_d = partdefinition.addOrReplaceChild("field_78174_d",
				...
				PartPose.offset(0.0F, -7.0F, 0.0F));
		PartDefinition field_78177_c = partdefinition.addOrReplaceChild("field_78177_c",
				CubeListBuilder.create().texOffs(60, 21).addBox(-13.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -7.0F, 0.0F));
		PartDefinition field_78175_e = partdefinition.addOrReplaceChild("field_78175_e",
		...
		PartDefinition field_78178_a = partdefinition.addOrReplaceChild("field_78178_a",
		...
		PartDefinition field_78173_f = partdefinition.addOrReplaceChild("field_78173_f", CubeListBuilder.create().texOffs(60, 0).mirror()
				.addBox(-3.5F, -3.0F, -3.0F, 6.0F, 16.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(5.0F, 11.0F, 0.0F));
