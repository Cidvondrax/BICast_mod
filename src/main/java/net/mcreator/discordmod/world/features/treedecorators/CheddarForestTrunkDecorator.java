...
public class CheddarForestTrunkDecorator extends TrunkVineDecorator {
	public static final CheddarForestTrunkDecorator INSTANCE = new CheddarForestTrunkDecorator();
	public static com.mojang.serialization.Codec<CheddarForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("cheddar_forest_tree_trunk_decorator");
