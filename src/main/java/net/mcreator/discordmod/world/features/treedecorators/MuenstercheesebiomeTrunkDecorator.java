...
public class MuenstercheesebiomeTrunkDecorator extends TrunkVineDecorator {
	public static final MuenstercheesebiomeTrunkDecorator INSTANCE = new MuenstercheesebiomeTrunkDecorator();
	public static com.mojang.serialization.Codec<MuenstercheesebiomeTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("muenstercheesebiome_tree_trunk_decorator");
