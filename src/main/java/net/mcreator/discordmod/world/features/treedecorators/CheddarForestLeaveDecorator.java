...
public class CheddarForestLeaveDecorator extends LeaveVineDecorator {
	public static final CheddarForestLeaveDecorator INSTANCE = new CheddarForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("cheddar_forest_tree_leave_decorator");
