...
public class CheesyShitteryTrunkDecorator extends TrunkVineDecorator {
	public static final CheesyShitteryTrunkDecorator INSTANCE = new CheesyShitteryTrunkDecorator();
	public static com.mojang.serialization.Codec<CheesyShitteryTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("cheesy_shittery_tree_trunk_decorator");
