...
public class MuenstercheesebiomeLeaveDecorator extends LeaveVineDecorator {
	public static final MuenstercheesebiomeLeaveDecorator INSTANCE = new MuenstercheesebiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("muenstercheesebiome_tree_leave_decorator");
