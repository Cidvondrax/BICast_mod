 ...
 *
 */
package net.mcreator.discordmod;
...
@Mod("discord_mod")
public class DiscordModMod {
	public static final Logger LOGGER = LogManager.getLogger(DiscordModMod.class);
	public static final String MODID = "discord_mod";
